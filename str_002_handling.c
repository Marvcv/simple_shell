 ...
 * @delim: The delimiters to check against.
 ...
 * @delim: The delimiters to tokenize by.
 * Return: A pointer to the next token found in str, NULL if no more tokens.
 */
 ...
 * Return: 1 if s consists of only digits, 0 otherwise.
 */
